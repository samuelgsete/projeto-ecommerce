...
public interface RepositorioCliente extends JpaRepository<Cliente, Integer> {
    ...
    @Query("SELECT c FROM Cliente c WHERE c.vendedorId = :vendedorId ORDER BY c.totalGasto ASC")
	Page<Cliente> listarClientesPorIdVendedor(@Param("vendedorId") Integer vendedorId, Pageable pageable);
