...
import br.com.samuel.ecommerce.repository.RepositorioPedido;
...
public class ServicoPedido {
    ...
    public Page<Pedido> listarPedidosPorIdNegocio(Integer negocioId, String filtro, Pageable pageable) { 
        ...
        return repositorioPedido.buscarPedidosPorIdVendedor(negocioId, pageable);
    }
    ...
    public ResponseEntity<Pedido> fazerPedido(Pedido pedido) throws EstoqueVazioException {
        ...
        servicoVenda.processarVendedor(pedido.getVendedorId(), pedido.getCusto(), pedido.getItens());
    ...
    public ResponseEntity<?> cancelarPedido(Integer id) {
        return repositorioPedido
                ...
                .map(pedidoCancelado -> {
                    ...
                    servicoVenda.cancelarProcessamentoVendedor(pedidoCancelado.getVendedorId(), pedidoCancelado.getCusto(), pedidoCancelado.getItens());
